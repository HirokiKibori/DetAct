...
namespace TestClient.Source
{
    ...
    public class DetActMessage
    {
        ...
        public static DetActMessage CreateFromJSON(string message)
        {
            return JsonSerializer.Deserialize<DetActMessage>(message);
        }
        ...
        public static DetActMessage CreateFromByteArray(byte[] message)
        {
            return JsonSerializer.Deserialize<DetActMessage>(message);
        }
